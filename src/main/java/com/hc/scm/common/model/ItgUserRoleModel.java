 ...
 * @version 1.0.0
 */
public class ItgUserRoleModel implements Serializable {
    /**
	 * 
	 */
    ...
    private List<ItgRoleListModel> itgRoleList; //角色list
    /**
     * 建档人
     */
	...
	public List<ItgRoleListModel> getItgRoleList() {
		return itgRoleList;
	}

	public void setItgRoleList(List<ItgRoleListModel> itgRoleList) {
		this.itgRoleList = itgRoleList;
	}
}